...
export default function Header(){
  ...
  function showMenuHandler(){
    ...
    return (
        <>
          <div className="flex justify-between items-center font-Vietnam py-10 px-5 md:px-0">
            <div>
            ...
            <div className="space-x-8 text-sm text-Dark-Blue font-medium hidden md:block">
              <button className="hover:duration-300 hover:text-Dark-Grayish-Blue">Pricing</button>
              <button className="hover:duration-300 hover:text-Dark-Grayish-Blue">Product</button>
              <button className="hover:duration-300 hover:text-Dark-Grayish-Blue">About Us</button>
              <button className="hover:duration-300 hover:text-Dark-Grayish-Blue">Careers</button>
              <button className="hover:duration-300 hover:text-Dark-Grayish-Blue">Community</button>
            </div>
            <button className="bg-Bright-Red text-sm font-medium text-white px-10 py-4 rounded-full shadow-xl shadow-Very-Pale-Red hover:duration-300 hover:bg-opacity-70 hidden md:block">Get Started</button>
            <button onClick={showMenuHandler} className="md:hidden block">
              {menu ? 
          ...
          {menu && <div className="fixed w-screen h-screen bg-gradient-to-b from-transparent to-black/55 z-50">
            <div className="bg-white w-[90%] mx-auto rounded shadow text-center font-Vietnam font-bold text-Dark-Blue py-8">
